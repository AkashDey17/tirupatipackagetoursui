...
//           <h2 className="eticket-trip-title">{operator || "Bus"} → Trip on {formattedDate}</h2>
//           <div className="eticket-ticket-number">
//             Ticket No: <strong>{tickets[0]?.TicketNo}</strong>
//           </div>
//         </div>
...
/* ROW 2 + ROW 3 combined (center text + right logo) */
.et-row2-center {
     display: flex;
    align-items: center;
    gap: 174px;
...
.trip-label {
  ...
  font-size: 13px;
       ...
       /* --- TRIP HEADER EXACT LIKE SCREENSHOT --- */
...
.eticket-title {
  ...
  margin: 0;
        ...
        .eticket-passenger-payment h4 {
padding: 15px;
    border-top: 1px solid lightgray;    padding: 10px;
}
        @media (min-width: 640px) {
          .eticket-journey-details { grid-template-columns: repeat(2, 1fr);  text-align: center; }
          .eticket-restrictions-grid { grid-template-columns: repeat(2, 1fr); }
        }
        @media (min-width: 1024px) {
          .eticket-journey-details { grid-template-columns: repeat(4, 1fr);  text-align: center; }
          .eticket-restrictions-grid { grid-template-columns: repeat(3, 1fr); }
  ...
  .trip-header-row {
    ...
    padding: 5px 0;
      ...
      <div className="eticket-container" ref={ticketRef}>
        ...
        {/* === PERFECT HEADER (Exact Like Screenshot) === */}
        <div className="et-top-container">

          {/* Row 1: Cancellation text + Help text */}
          <div className="et-row1">
            <div className="et-cancel-text">
              Cancellation and refund are not applicable for Tirupati trips/packages.
            </div>
            ...
            <div className="et-help-text">
              ...
              <a href="https://www.tirupatipackagetours.com/">
                https://www.tirupatipackagetours.com/
              </a>
            </div>
          </div>

          {/* Row 2 + Row 3 combined: Center text + Logo on Right */}
          <div className="et-row2-center">
            <img src={logoImg} alt="Logo" className="et-logo-right" />
            <div className="et-center-text">
              <div className="et-ticket-title">eTICKET</div>
              <div className="et-dharshana">Sarva (Free) Dharshana</div>
            </div>
        ...
        <div className="trip-header-container">
          ...
          <div className="trip-header-row">
            <span className="trip-city">{boardingPoint?.City || "Bengaluru"}</span>

            <span className="trip-arrow">⇆</span>

            <span className="trip-title">
              Tirupati Balaji Darshan {formattedDate}
            </span>
          </div>

          <div className="trip-yellow-line"></div>
        ...
        <div className="ticket-info-header">
          ...
          <div className="ticket-info-row">
            <span className="left-info">
              {/* Ticket no: <b>TM{Math.floor(Math.random() * 9999999999)}</b> */}
               Ticket No: <b>{tickets?.[0]?.TicketNo || "TM12345678"}</b>
            </span>

            <span className="right-info">
              Coach Number: <b>{busNumber || "N/A"}</b>
            </span>
          </div>

          <div className="ticket-info-row">
            <span className="left-info">
              Ticket Details for: <b>{passengerName}</b>
            </span>

            <span className="right-info">
              Bus Name: <b>{operator || "SANCHAR6T"}</b>
            </span>
          </div>

          <div className="ticket-yellow-line"></div>
        ...
        <div className="eticket-journey-details">
          <div>
            <p className="eticket-detail-label">Coach Type</p>
            <p className="eticket-detail-value">{coachType || busType}</p>
          </div>
          <div>
            <p className="eticket-detail-label">Reporting <br /> time</p>
            <p className="eticket-detail-value">{departureTime}</p>
          </div>
          <div>
            <p className="eticket-detail-label">Departure <br /> time</p>
            <p className="eticket-detail-value">{departureTime}</p>
          </div>
          <div>
            <p className="eticket-detail-label">Number of
              <br /> Passengers</p>
            <p className="eticket-detail-value">{travellerData?.length}</p>
          </div>
        </div>
        ...
        <div className="trip-table">
          ...
          <div className="trip-col">
            <h3 className="trip-col-title">Boarding point details</h3>

            <p className="trip-text">{boardingPoint?.PointName}</p>
            <p className="trip-text">{boardingPoint?.Landmark}</p>
            <p className="trip-text">{boardingPoint?.Address}</p>

            <p className="trip-phone">{boardingPoint?.ContactNo || "N/A"}</p>
            <p className="trip-label">Contact Info</p>
          </div>
          ...
          {/* Dropping column */}
          <div className="trip-col">
            <h3 className="trip-col-title">Dropping point details</h3>

            <p className="trip-text">{droppingPoint?.PointName}</p>
            <p className="trip-text">{droppingPoint?.Landmark}</p>
            <p className="trip-text">{droppingPoint?.Address}</p>

            <p className="trip-phone">{droppingPoint?.ContactNo || "N/A"}</p>
            <p className="trip-label">Contact Info</p>
          </div>
          ...
          {/* Booking details */}
          <div className="trip-col">
            <h3 className="trip-col-title">Booking details</h3>

            <p className="trip-text">
              {formattedDate} <br />
              <span className="trip-label">Booked On</span>
            </p>

            <p className="trip-text">
              {passengerName} <br />
              <span className="trip-label">Booked By</span>
            </p>

            <p className="trip-text">
              {contactData?.ContactNo} <br />
              <span className="trip-label">Contact Details</span>
            </p>

            <p className="trip-text">
              {contactData?.Email} <br />
              <span className="trip-label">Email</span>
            </p>

            <p className="trip-text">
              {new Date(travelDate).toLocaleDateString("en-IN")} to{" "}
              {new Date(travelDate).toLocaleDateString("en-IN")}
            </p>
            <p className="trip-label">Journey Details</p>
          </div>
